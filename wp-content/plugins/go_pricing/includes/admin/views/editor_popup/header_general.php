	...
	<tr>
		...
		<td>
			<div class="gwa-img-upload">
				...
				<div class="gwa-input-btn"><input type="text" name="custom[img][data]" value="<?php echo ( !empty( $postdata['custom']['img']['data'] ) ?  esc_attr( $postdata['custom']['img']['data'] ) : '' ); ?>"><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
			</div>
		</td>
