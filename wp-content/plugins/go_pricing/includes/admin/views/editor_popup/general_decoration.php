	...
	<tr data-parent-id="col-sign-type" data-parent-value="custom-img"<?php echo ( empty($postdata['col-sign-type'] ) ||$postdata['col-sign-type'] != 'custom-img' ? ' style="display:none;"' : '' ); ?>>
		...
		<td>
			<div class="gwa-img-upload">
				...
				<div class="gwa-input-btn"><input type="text" name="col-sign[custom-img][data]" value="<?php echo ( !empty($postdata['col-sign']['custom-img']['data'] ) ?  esc_attr($postdata['col-sign']['custom-img']['data'] ) : '' ); ?>"><a href="#" title="<?php esc_attr_e( 'Add', 'go_pricing_textdomain' ); ?>" data-action="img-upload"><i class="fa fa-plus-circle"></i></a></div>
			</div>															
		</td>
