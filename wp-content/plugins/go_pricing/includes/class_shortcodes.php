...
class GW_GoPricing_Shortcodes {
	...
	public function pricing_table_sc( $atts, $content = null ) {
		...
		foreach ( (array)$pricing_table['col-data'] as $col_index => $col_data ) {
			...
			/* Decoration */
			if ( isset( $col_data['decoration'] ) && is_string( $col_data['decoration'] ) ) parse_str( $col_data['decoration'], $col_data['decoration'] );			

			/* Header Style */
			if ( isset( $col_data['header']['style'] ) && is_string( $col_data['header']['style'] ) ) parse_str( $col_data['header']['style'], $col_data['header']['style'] );
			
			/* Header General */
			if ( isset( $col_data['header']['general'] ) && is_string( $col_data['header']['general'] ) ) parse_str( $col_data['header']['general'], $col_data['header']['general'] );						

			/* Title */
			if ( isset( $col_data['title'] ) && is_string( $col_data['title'] ) ) parse_str( $col_data['title'], $col_data['title'] );			

			/* Body row */
			if ( isset( $col_data['body-row'] ) && is_string( $col_data['body-row'] ) ) parse_str( $col_data['body-row'], $col_data['body-row'] );						
			...
			if ( !empty( $column_style_data['type'] ) ) {
				...
				if ( $column_style_data['type'] != 'html' && $column_style_data['type'] != 'chtml' ) {
					...
					if ( $column_style_data['type'] != 'team' && $column_style_data['type'] != 'cteam' ) {
						...
						if ( isset( $col_data['price'] ) && is_string( $col_data['price'] ) ) parse_str( $col_data['price'], $col_data['price'] );						
			...
			foreach ( (array)$pricing_table['col-data'][$col_index]['body-row'] as $body_row_index => $body_row_data ) {
				...
				if ( is_string( $body_row_data ) ) parse_str( $body_row_data, $body_row_data );
			...
			foreach ( (array)$pricing_table['col-data'][$col_index]['footer-row'] as $footer_row_index => $footer_row_data ) {
				...
				if ( is_string( $footer_row_data ) ) parse_str( $footer_row_data, $footer_row_data );
