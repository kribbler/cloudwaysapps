	...
	*/
    ...
    if ( !function_exists('sf_addtocart_button') ) {
        function sf_addtocart_button( $atts, $content = null ) {
            ...
            $button_output = '<div class="add-to-cart-wrap add-to-cart-shortcode" data-toggle="tooltip" data-placement="top" title="" data-tooltip-added-text="'.__("Added to cart", "swiftframework").'" data-original-title="'.__("Add to cart", "swiftframework").'">';
