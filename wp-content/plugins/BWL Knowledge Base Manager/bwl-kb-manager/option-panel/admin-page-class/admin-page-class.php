...
*/
    public function Load_page_hooker(){
      ...
      if(isset($_POST['action']) && $_POST['action'] == 'save') {
        ...
        if ( class_exists('BWL_Disable_Crud') && in_array( 'bwl-disable-crud/bwl-disable-crud.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
            return false;
        }
...
//      $slug = "plugin_panel"; // custom slug panel
