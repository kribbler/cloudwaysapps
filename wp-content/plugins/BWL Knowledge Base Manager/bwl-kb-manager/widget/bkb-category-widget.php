...
class BKB_categories_widget extends WP_Widget {
    ...
    public function __construct() {
         parent::__construct(
                 ...
                 array('description' => __('Display Knowledget Base Categories.' , 'bwl-kb'))
            );
    }
...
//        $instance['entries_display'] =  strip_tags($new_instance['entries_display']);
    ...
    public function widget($args, $instance) {
        ...
        <ul class="bkb-widget">       
            ...
            <?php wp_list_categories(array('title_li'=> '', 'taxonomy'=> 'bkb_category',  'show_count' => $show_count, 'depth'=> 2)); ?>
